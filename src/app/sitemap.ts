...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/guide/scientific-evidence`, lastModified: d("2026-07-03"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/guide/sensation-and-craving-science`, lastModified: d("2026-07-03"), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${baseUrl}/t/accountability-partner-definition`, lastModified: d("2026-04-18"), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${baseUrl}/t/daily-handwriting-practice-pdf-free`, lastModified: d("2026-04-18"), changeFrequency: "monthly", priority: 0.7 },
    // Printable tools
    { url: `${baseUrl}/daily-sit-log/print`, lastModified: d("2026-04-18"), changeFrequency: "yearly", priority: 0.5 },
    // Practice Buddy
