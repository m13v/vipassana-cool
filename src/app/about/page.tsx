...
export const metadata: Metadata = {
  title: "About — Everything You Need to Know About Vipassana Meditation",
  description:
    "An unofficial companion guide to dhamma.org with honest answers, preparation tips, and personal experience from a practitioner with 60 days of courses completed.",
  alternates: {
