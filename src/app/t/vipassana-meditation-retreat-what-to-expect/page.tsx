...
const timetable: { time: string; block: string }[] = [
  ...
  { time: "4:30 to 6:30 AM", block: "Meditation in the hall or your room" },
  { time: "6:30 to 8:00 AM", block: "Breakfast break and rest" },
  { time: "8:00 to 9:00 AM", block: "Group sitting in the hall" },
  { time: "9:00 to 11:00 AM", block: "Meditation in the hall or your room" },
  { time: "11:00 to 12:00", block: "Lunch break" },
  { time: "12:00 to 1:00 PM", block: "Rest and teacher interviews" },
  { time: "1:00 to 2:30 PM", block: "Meditation" },
  { time: "2:30 to 3:30 PM", block: "Group sitting in the hall" },
  { time: "3:30 to 5:00 PM", block: "Meditation" },
  { time: "5:00 to 6:00 PM", block: "Tea break" },
  { time: "6:00 to 7:00 PM", block: "Group sitting in the hall" },
  { time: "7:00 to 8:15 PM", block: "Evening discourse" },
  { time: "8:15 to 9:00 PM", block: "Group sitting in the hall" },
  { time: "9:00 to 9:30 PM", block: "Question time, then lights out" },
];
