  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>
          Cults tell you what to think. The Vipassana tradition does the opposite: the explicit message is &quot;don&apos;t take anyone&apos;s word for it, practice and see for yourself.&quot; Students are encouraged to maintain whatever religion they follow. There&apos;s no doctrine to adopt beyond attending the course and practicing what was taught there.
        </p>
      ...
      <section>
        ...
        <ul className="mt-3 list-disc space-y-2 pl-6">
          ...
          <li><strong>The technique is taught as-is:</strong> students are asked not to mix it with other meditation techniques during the course. This protects the integrity of the practice but can feel dogmatic.</li>
